---
title: "Phoenix Tools Reference Guide"
---

## What Can Phoenix Do?

Phoenix is your AI assistant that can:
...
3. **Review Changes**
    - Phoenix will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Phoenix repository](https://github.com/phoenix/phoenix/blob/main/src/core/Phoenix.ts).

Phoenix has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Phoenix can then access
    - Example: Create a weather API tool that Phoenix can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/phoenix)
-   Check the documentation
-   Provide feedback to improve Phoenix
