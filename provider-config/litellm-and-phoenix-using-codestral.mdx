---
title: "LiteLLM & Phoenix (using Codestral)"
description: "Learn how to set up and run LiteLLM with Phoenix using the Codestral model. This guide covers Docker setup, configuration, and integration with Phoenix."
---

### Using LiteLLM with Phoenix

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Phoenix.
...
2. **Setup Phoenix**
    ...
    Once the LiteLLM server is up and running you can set it up in Phoenix:
...
-   [Phoenix Discord Community](https://discord.gg/phoenix)
