...
<Frame>
	<img
		src="https://storage.googleapis.com/phoenix_public_images/docs/assets/newtask.png"
		alt="Using the /newtask slash command"
	/>
</Frame>

-   Type `/newtask` in the chat input field
-   Phoenix will analyze your conversation and propose a distilled version of the context to carry forward
...
Rather than losing those insights or starting from scratch, I use `/newtask` to have Phoenix extract what matters - the key decisions, file changes, and progress so far - without all the noise of individual tool calls and research steps.
