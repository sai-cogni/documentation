...
<Frame>
	<img src="https://storage.googleapis.com/phoenix_public_images/docs/assets/smol.png" alt="Using the /smol slash command" />
</Frame>

-   Type `/smol` (or its alias `/compact`) in the chat input field
-   Phoenix will analyze your conversation and create a detailed summary that preserves essential information
