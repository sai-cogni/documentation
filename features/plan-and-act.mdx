...
Plan & Act modes represent Phoenix's approach to structured AI development, emphasizing thoughtful planning before implementation. This dual-mode system helps developers create more maintainable, accurate code while reducing iteration time.
...
Plan mode is where you and Phoenix figure out what you're trying to build and how you'll build it. In this mode, Phoenix:
...
Once you've got a plan, you switch to Act mode. Now Phoenix:
...
<Frame>
	<img src="https://storage.googleapis.com/phoenix_public_images/docs/assets/image%20(5).png" alt="Act mode capabilities" />
</Frame>
...
1. I start in Plan mode and tell Phoenix what I want to build
2. Phoenix helps me explore the codebase, looking at relevant files
...
5. Phoenix implements the solution based on our planning
...
<Frame>
	<img src="https://storage.googleapis.com/phoenix_public_images/docs/assets/image%20(5)%20(1).png" alt="Plan mode workflow" />
</Frame>

-   Share your requirements
-   Let Phoenix analyze relevant files
-   Engage in dialogue to clarify objectives
-   Develop implementation strategy

<Frame>
	<img
		src="https://storage.googleapis.com/phoenix_public_images/docs/assets/image%20(2)%20(1)%20(1)%20(1).png"
		alt="Planning phase"
	/>
</Frame>
...
<Frame>
	<img src="https://storage.googleapis.com/phoenix_public_images/docs/assets/switching-to-act.gif" alt="Switching to Act mode" />
</Frame>

Act mode allows Phoenix to:
...
3. Point Phoenix to relevant files if he hasn't read them
...
<Frame>
	<img
		src="https://storage.googleapis.com/phoenix_public_images/docs/assets/image%20(3)%20(1).png"
...
-   Have Phoenix write markdown files of the plan for future reference
...
<Frame>
	<img src="https://storage.googleapis.com/phoenix_public_images/docs/assets/image%20(6).png" alt="Mode usage patterns" />
</Frame>
...
-   Join our [Discord community](https://discord.gg/phoenix)
