---
title: "Task Management in Phoenix"
description: "Learn how to effectively manage your task history, use favorites, and organize your work in Phoenix."
---

# Task Management

As you use Phoenix, you'll accumulate many tasks over time. The task management system helps you organize, filter, search, and clean up your task history to keep your workspace efficient.

## Accessing Task History

You can access your task history by:

1. Clicking on the "History" button in the Phoenix sidebar
2. Using the command palette to search for "Phoenix: Show Task History"
...
-   **Open**: Click on a task to reopen it in the Phoenix chat
...
Task management helps you maintain an organized workflow when using Phoenix, allowing you to quickly find past conversations, preserve important work, and keep your history clean and efficient.
