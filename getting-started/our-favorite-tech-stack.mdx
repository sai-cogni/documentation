...
description: "A curated list of our recommended technologies and tools for building modern web applications with Phoenix."
---

## Recommended Stack for New Phoenix Users (2025)
...
1. Install the development essentials:
    - Follow our [Development Essentials Installation Guide](https://docs.phoenix.bot/getting-started/installing-dev-essentials)
2. Set up Phoenix's Memory Bank:
    - Follow the [Memory Bank setup instructions](https://docs.phoenix.bot/prompting/phoenix-memory-bank)
    - Create an empty `phoenix_docs` folder in your project root
    - Create `projectBrief.md` in the `phoenix_docs` folder (see example below)
    - Tell Phoenix to "initialize memory bank"
3. Add our recommended stack configuration:
    - Create `.phoenixrules` file (see template below)
    - Let Phoenix handle the rest!
...
-   Be reviewed by Phoenix before execution
    Example: 001_create_users_table.sql

## Development Workflow

-   Phoenix helps write and review code changes
-   Vercel automatically deploys from main branch
-   Database migrations reviewed by Phoenix before execution
...
1. Use `/help` in Phoenix chat for immediate assistance
2. Check [Phoenix Documentation](https://docs.phoenix.bot)
3. Join our [Discord Community](https://discord.gg/phoenix)
4. Search GitHub issues for common problems

Remember: Phoenix is here to help at every step. Just ask for guidance or clarification when needed!
